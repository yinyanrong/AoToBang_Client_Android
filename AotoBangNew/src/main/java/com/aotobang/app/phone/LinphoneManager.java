...
public class LinphoneManager implements LinphoneCoreListener {
	...
	protected LinphoneManager(final Context c,Handler mHandler) {
	...
	public synchronized static final LinphoneManager createAndStart(Context c,Handler handler) {
		if (instance != null)
			throw new RuntimeException("Linphone Manager is already initialized");

		instance = new LinphoneManager(c,handler);
	...
	public void newOutgoingCall(AddressType address) {
		...
		//LogUtil.info(LinphoneManager.class, "to"+to+"----getDisplayedName"+address.getDisplayedName());
	}
