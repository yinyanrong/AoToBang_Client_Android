...
import com.aotobang.app.MainActivity;
...
public final class LinphoneService extends Service {
	...
	private CallComingListener listener;
		...
		new Thread(){
			public void run() {
				...
				//	mNM.cancel(INCALL_NOTIF_ID); // in case of crash the icon is not removed
					...
					//Intent notifIntent = new Intent(LinphoneService.this, incomingReceivedActivity);
				...
				//	mNotif = Compatibility.createNotification(this, mNotificationTitle, "", R.drawable.ic_launcher, IC_LEVEL_OFFLINE, bm, mNotifContentIntent, true);

					LinphoneManager.createAndStart(LinphoneService.this,mHandler);

					instance = LinphoneService.this; // instance is ready once linphone manager has been created
					LinphoneManager.getLc().addListener(mListener = new LinphoneCoreListenerBase(){
						...
						public void callState(LinphoneCore lc, LinphoneCall call, LinphoneCall.State state, String message) {
							...
							if (state == LinphoneCall.State.IncomingReceived) {
								//onIncomingReceived();
								if(listener!=null)
									listener.onCallComing(lc, call, state, message);
								/*else 
...
//							}
					...
					Intent intent = new Intent(LinphoneService.this, KeepAliveHandler.class);
				    mkeepAlivePendingIntent = PendingIntent.getBroadcast(LinphoneService.this, 0, intent, PendingIntent.FLAG_ONE_SHOT);
					((AlarmManager) LinphoneService.this.getSystemService(Context.ALARM_SERVICE)).setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP
	...
	*/
	...
	/*public synchronized void sendNotification(int level, int textId) {
		...
		mNotif = Compatibility.createNotification(this, mNotificationTitle, text, R.drawable.ic_launcher, level, bm, mNotifContentIntent, true);
	...
	public void registIncomingListener(CallComingListener listener){
