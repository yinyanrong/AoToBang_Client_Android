...
public class AotoPreferenceUtils {
	/**
	 * 保存Preference的name
	 */
	public static final String PREFERENCE_NAME = "saveInfo";
	private static SharedPreferences mSharedPreferences;
	private static AotoPreferenceUtils mPreferenceUtils;
	...
	private AotoPreferenceUtils(Context cxt) {
	...
	public static synchronized void init(Context cxt){
	    if(mPreferenceUtils == null){
	        mPreferenceUtils = new AotoPreferenceUtils(cxt);
	    }
	}
	 ...
	 * @return
	 */
	public static AotoPreferenceUtils getInstance() {
		if (mPreferenceUtils == null) {
